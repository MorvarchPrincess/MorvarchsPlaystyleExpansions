    ...
    class HellknightShadow
    {
        public static void Configure()
        {
            ...
            BlueprintFeature HellknightsDread = FeatureConfigurator.New("HellknightsDread", Template.HellknightsDread)
                ...
                "near all they come across. This gives the Hellknight Shadow a bonus to persuasion checks to intimidate equal to the Shadow's Class Level.", false))
                //.AddContextStatBonus(StatType.CheckIntimidate, DreadContextValue, Kingmaker.Enums.ModifierDescriptor.Insight, 0, 1)
                .AddStatBonus(Kingmaker.Enums.ModifierDescriptor.Insight, false, StatType.CheckIntimidate, 5)
            ...
            BlueprintCharacterClass Shadow = CharacterClassConfigurator.New("Hellknight Shadow", Template.HellknightShadow)
                ...
                .AddPrerequisiteFullStatValue(false, Kingmaker.Blueprints.Classes.Prerequisites.Prerequisite.GroupType.All, false, false, StatType.SneakAttack, 2)
